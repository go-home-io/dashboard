...
class PresenceSensor extends React.Component {
    render () {
        const {classes, on, battery_level} = this.props;
...
PresenceSensor.propTypes = {
    classes: PropTypes.object.isRequired,
    on: PropTypes.bool.isRequired,
    battery_level: PropTypes.number
};

export default withStyles(styles)(PresenceSensor);
